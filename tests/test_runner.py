...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("test_frontend_rat", "front_end_rat", "FrontEndRAT.vhdl"),
        ("test_freelist", "free_list", "FreeList.vhdl"),
        ("test_alu_arbiter", "alu_arbiter", "ALUArbiter.vhdl"),
        ("test_alu_rs_entry", "alu_rs_entry", "ALU_RS_Entry.vhdl"),
        ...
        ("test_btb", "branch_target_buffer", "btb.vhdl"),
        ("test_frontend_top", "frontend_top", "frontend_top.vhdl"),
    ],
)
